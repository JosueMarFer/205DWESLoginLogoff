CREATE DATABASE IF NOT EXISTS DB205DWESLoginLogoff;
...
CREATE USER IF NOT EXISTS 'user205DWESLoginLogoff'@'%' IDENTIFIED BY 'paso';

GRANT ALL PRIVILEGES ON DB205DWESLoginLogoff.* TO 'user205DWESLoginLogoff'@'%';
